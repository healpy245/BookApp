<x-guest-layout>
    <form method="POST" action="{{ route('register.staff') }}">
        ...
        <div class="mt-4">
            ...
            <select id="vendor_id" name="vendor_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
