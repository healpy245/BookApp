                                ...
                                @forelse($bookings as $booking)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <div class="text-sm text-gray-500">${{ number_format($booking->total_price, 2) }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            @if($booking->status === 'pending')
                                                <a href="{{ route('bookings.edit', $booking) }}" class="text-yellow-600 hover:text-yellow-900 mr-3">Edit</a>
