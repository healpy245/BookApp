                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('services.update', $service->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="3">{{ old('description', $service->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="duration" name="duration" type="number" class="mt-1 block w-full" :value="old('duration', $service->duration)" required />
